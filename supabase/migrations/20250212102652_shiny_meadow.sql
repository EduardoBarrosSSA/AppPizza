/*
  # Fix driver delivery access and permissions

  1. Changes
    - Update policies to properly handle driver authentication
    - Add policy for drivers to read their own deliveries
    - Fix driver email parsing in policies
    - Add better error handling for driver functions
