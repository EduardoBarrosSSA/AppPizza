  ...
  async function loadData() {
    try {
      ...
      const { data: statsData, error: statsError } = await supabase
        .rpc('get_driver_stats', { phone_number: phone });
      ...
      if (statsData?.[0]) {
        setStats({
          totalDeliveries: statsData[0].total_deliveries,
          totalEarnings: statsData[0].total_earnings,
          pendingDeliveries: statsData[0].pending_deliveries
        });
      }

      // Get driver deliveries
      const { data: deliveriesData, error: deliveriesError } = await supabase
        .rpc('get_driver_deliveries', { phone_number: phone });
